...
public class JanelaVisualizarProposta implements Initializable {
    ...
    public void displayName(String proposta) {
        ...
        utilizadorRestDTO = utilizadorController.getUtilizadorById(propostaCompleta.getCodUtilizador());
        String nomeUtilizador = utilizadorRestDTO.getNome() + " " + utilizadorRestDTO.getSobrenome();
