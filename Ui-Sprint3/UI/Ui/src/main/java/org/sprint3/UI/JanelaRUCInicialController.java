...
public class JanelaRUCInicialController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //cmbEdicao.getItems().addAll(edicaoController.getListaEdicoesByCodRUC());
        cmbEdicao.getItems().addAll("POO-2022", "PDS-2022");
    ...
    public void handleButtonAction(ActionEvent actionEvent) throws IOException {
        ...
        JanelaRUCController janelaController = loader.getController();
