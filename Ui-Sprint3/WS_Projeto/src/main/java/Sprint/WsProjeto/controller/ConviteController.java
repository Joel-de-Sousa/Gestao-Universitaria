...
public class ConviteController {
    ...
    @GetMapping("/{codConvite}")
    @ResponseBody
    public ResponseEntity<Object> findConviteByCodConvite (@PathVariable int codConvite) {

        ConviteDTO oConvite = conviteService.findConviteByCodConvite (codConvite);
        ...
        @GetMapping("/codDocente/{codDocente}")
        @ResponseBody
        public ResponseEntity<Object> findConviteByCodDocente (@PathVariable int codDocente) {

          ConviteDTO oConvite = conviteService.findConviteByCodDocente(codDocente);
