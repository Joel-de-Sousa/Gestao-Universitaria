...
public class JanelaNovaProposta implements Initializable {
    ...
    @FXML
    private ComboBox<String> cmbxEdicao;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cmbxEdicao.getItems().addAll(propostaController.getListaEdicoes());
        reniciarDisable();
    ...
    @FXML
    public void actBtnConfirmar(ActionEvent actionEvent) throws Exception {
        try {
