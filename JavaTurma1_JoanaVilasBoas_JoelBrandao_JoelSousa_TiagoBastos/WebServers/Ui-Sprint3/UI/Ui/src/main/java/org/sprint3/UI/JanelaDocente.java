...
public class JanelaDocente implements Initializable {
    ...
    public void handleCbProjetoAction(ActionEvent actionEvent) {
        ...
        list.add("Submissao 1");
        list.add("Submissao 2");
        ...
        listView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                submissaoSeleccionada = (String) listView.getSelectionModel().getSelectedItem();
    ...
    @FXML
    public void handleButtonVisualizarAction(ActionEvent actionEvent) {
    }
}
